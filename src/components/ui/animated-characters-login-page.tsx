...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2">
      ...
      <div className="relative hidden lg:flex flex-col justify-between bg-gradient-to-br from-primary/95 via-primary to-primary/80 p-12 text-primary-foreground">
        ...
        <div className="w-full max-w-[420px]">
          ...
          <div className="mt-6">
            <Button
              ...
              type="button"
            >
              <Mail className="mr-2 size-5" /> Log in with Google
            </Button>
          </div>
